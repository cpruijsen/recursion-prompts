...
var exponent = function(base, exp, result, posOrNeg) {
  var result = result || base;
  var posOrNeg = posOrNeg || "pos";

  if(exp === 1 && posOrNeg === "pos"){
    return result;
  } else if(exp === 0 && posOrNeg === "pos"){
    return 1;
  } else if(exp === 0 && posOrNeg === "neg"){
    return result/base;
  } else if(exp<0){
    result = result / base;
    posOrNeg = "neg";
    exp = exp + 1;
    return exponent(base, exp, result, posOrNeg);
  } else{
    result = result * base;
    exp = exp -1;
    return exponent(base, exp, result, posOrNeg);
...
var reverse = function(string, arr, secondArr) {
  var arr = arr || string.split('');
  var secondArr = secondArr || [];
  if(secondArr.length === arr.length+5){
...
var multiply = function(x, y, counter, result) {
